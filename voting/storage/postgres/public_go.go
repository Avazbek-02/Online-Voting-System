...
func (repo *PublicVoteRepo) UpdatePublicVote(id string, req *v.CreatePublicVoteRequest) (*v.PublicVoteResponse, error) {
	query := `
	...
	return repo.GetPublicVoteInfo(&v.GetPublicVoteInfoRequest{Id: id})
}
